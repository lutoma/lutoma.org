<template>
	<nav v-click-outside="closeMobileMenu">
		<div class="mobile-visible">
			<NuxtLink to="/" v-on:click.native="scrollToTop"><h1>lutoma</h1></NuxtLink>
		...
		<div :class="{'nav-content': true, 'nav-content-show-mobile': showMobileMenu}">
			<div class="nav-center">
				<ul>
					<li><NuxtLink to="/photos" v-on:click.native="closeMobileMenu">Photography</NuxtLink></li>
					<li><NuxtLink to="/code" v-on:click.native="closeMobileMenu">Code</NuxtLink></li>
					<li><NuxtLink to="/contact" v-on:click.native="closeMobileMenu">Contact</NuxtLink></li>
				</ul>
			</div>
			...
			<div class="social">
				<ul>
					...
					<li><a href="https://github.com/lutoma" rel="me noopener" target="_blank"><fa :icon="['fab', 'github']" /></a></li>
